# Contributing to Cryptator API

The Cryptator team encourages community feedback and contributions.
Thank you for your interest in making Cryptator API Machina better! There are several ways you can get involved.

If you are looking for a good way to contribute to the project, please:

* have a look at the [available issue templates](https://github.com/arnaud-m/cryptator-api/issues/new/choose)
and checkout the [examples of good first issues](https://github.com/arnaud-m/cryptator-api/contribute)
(or [click here](https://github.com/arnaud-m/cryptator-api/labels/good%20first%20issue)).

* look through the [issues that need help](https://github.com/arnaud-m/cryptator-api/labels/help%20wanted).
...
the [Bug Report template](https://github.com/arnaud-m/cryptator-api/issues/new?assignees=&labels=bug&template=bug_report.md&title=[BUG]).
Should the template provided not suit your needs, feel free to make a
[custom Bug Report](https://github.com/arnaud-m/cryptator-api/issues/new/choose),
but please label it accordingly.

We are happy to hear your ideas for how to further improve cryptator-api,
ensuring it suits your needs. Check the [Issues](https://github.com/arnaud-m/cryptator-api/issues)
and see if others have submitted similar feedback. You can upvote existing feedback
(using the thumbs up reaction/by commenting) or [submit a new suggestion](https://github.com/arnaud-m/cryptator-api/labels/feature).

We always look at upvoted items in [Issues](https://github.com/arnaud-m/cryptator-api/issues)
...
Issues marked [`good first issue`](https://github.com/arnaud-m/cryptator-api/labels/good%20first%20issue)
are a good place to start.

You can also check the [`help wanted`](https://github.com/arnaud-m/cryptator-api/labels/help%20wanted)
...
from reviewers. Try looking at [past pull requests](https://github.com/arnaud-m/cryptator-api/pulls?q=is%3Apr+is%3Aclosed)
